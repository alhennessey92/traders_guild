...
extension Date {
    ...
    func label(for timeframe: RLChartTimeframe) -> String {
        let formatter = DateFormatter()
...
extension Array where Element == RLCandleDTO {
    ...
    func visibleCandles(in range: Range<Int>) -> ArraySlice<RLCandleDTO> {
