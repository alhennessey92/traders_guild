...
extension Candle {
    ...
    private static func defaultBasePrice(for symbol: TradingSymbol) -> Double {
        ...
        case .crypto:
            if symbol.symbol.contains("BTC") {
                return 45000.0
            } else if symbol.symbol.contains("ETH") {
                return 2500.0
            } else {
                return 1.0  // Altcoins
            }
        ...
        case .commodities:
            if symbol.symbol.contains("GOLD") || symbol.symbol.contains("XAU") {
                return 2000.0
            } else if symbol.symbol.contains("OIL") || symbol.symbol.contains("CL") {
                return 75.0
            } else {
                return 100.0
            }
        ...
        case .indices:
            if symbol.symbol.contains("SPX") || symbol.symbol.contains("SP500") {
                return 4500.0
            } else if symbol.symbol.contains("NDX") || symbol.symbol.contains("NASDAQ") {
                return 15000.0
            } else if symbol.symbol.contains("DJI") || symbol.symbol.contains("DOW") {
                return 35000.0
            } else {
                return 1000.0
            }
    ...
    private static func defaultVolatility(for symbol: TradingSymbol) -> Double {
        switch symbol.assetClass {
        case .forex:
    ...
    static func randomWithVolatility(
        ...
        return Candle(
            ...
            close: close,
            timestamp: timestamp,
            volume: Double.random(in: 100_000...1_000_000)
        )
    }
}
