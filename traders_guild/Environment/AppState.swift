...
//    @Published var showLoginSheet: Bool = false
    ...
    /// Called when chart has finished initial load
    func chartDidBecomeReady() {
        isChartReady = true
    }

    /// Reset chart ready state (called on logout or guild change)
    func resetChartReadyState() {
        isChartReady = false
    }
    
    /// Reset transition state to show transition again (called before loading chart)
    ...
    func selectGuild(_ guild: GuildMembershipDTO) {
        // Show transition overlay while chart loads for new guild
        showTransitionForChartLoad()
        currentGuild = guild
    }
    ...
    func showSuccess(_ message: String) {
        // Your success toast/alert implementation
    }
    ...
    // ================================================================================================
    // MARK: - User Profiles - API
    // ================================================================================================
    
    
    // MARK: - Fetch Extended Profile
    
    /// Fetch extended profile information for a user
    /// - Parameter userId: The user's ID
    /// - Returns: Extended profile data including bio, interests, experience
    func fetchUserExtendedProfile(userId: UUID) async throws -> UserProfileExtendedDTO {
        // In production, this would call the API
        // For now, return sample data
        return SampleData.currentUserExtendedProfile
    }
    
    /// Fetch extended profile for a guild member
    func fetchMemberExtendedProfile(membershipId: UUID) async throws -> UserProfileExtendedDTO {
        // In production, this would call the API
        return SampleData.memberExtendedProfile
    }
    
    // MARK: - Fetch User Markers
    
    /// Fetch markers placed by a specific user
    /// - Parameters:
    ///   - userId: The user's ID
    ///   - limit: Maximum number of markers to return
    /// - Returns: Array of markers placed by the user
    func fetchUserMarkers(userId: UUID, limit: Int = 20) async throws -> [TopMarkerDTO] {
        // In production, this would call the API
        return SampleData.userPlacedMarkers
    }
    
    /// Fetch markers summary for a user
    func fetchUserMarkersSummary(userId: UUID) async throws -> UserMarkersSummaryDTO {
        // In production, this would call the API
        return SampleData.currentUserMarkersSummary
    }
    
    // MARK: - Fetch Awards
    
    /// Fetch all awards earned by a user
    /// - Parameter userId: The user's ID
    /// - Returns: Array of awards
    func fetchUserAwards(userId: UUID) async throws -> [UserAwardDTO] {
        // In production, this would call the API
        return SampleData.currentUserAwards
    }
    
    /// Fetch awards summary for a user
    func fetchUserAwardsSummary(userId: UUID) async throws -> AwardsSummaryDTO {
        // In production, this would call the API
        return SampleData.awardsSummary
    }
    
    /// Fetch awards for a guild member
    func fetchMemberAwards(membershipId: UUID) async throws -> [UserAwardDTO] {
        // In production, this would call the API
        return SampleData.memberAwards
    }
    ...
    func updateUserProfile(_ profile: UserProfileExtendedDTO) async throws {
        // In production, this would call the API
    ...
    func updateUserInterests(_ interests: [TradingInterestDTO]) async throws {
        // In production, this would call the API
        showSuccess("Interests updated")
    }
    
    /// Update user trading experience
    func updateUserExperience(_ experience: TradingExperience) async throws {
        // In production, this would call the API
        showSuccess("Experience level updated")
    }
    
    /// Update user preferred pairs
    func updateUserPreferredPairs(_ pairs: [String]) async throws {
        // In production, this would call the API
        showSuccess("Preferred pairs updated")
    }
    
    // MARK: - Social Links
    
    /// Add a social link to user profile
    func addSocialLink(_ link: SocialLinkDTO) async throws {
        // In production, this would call the API
        showSuccess("Social link added")
    }
    
    /// Remove a social link from user profile
    func removeSocialLink(linkId: UUID) async throws {
        // In production, this would call the API
