...
//                Image(systemName: "shield.pattern.checkered")
//                    .font(.headline)
//                    .foregroundColor(isCurrentGuild ? AppColors.accentColor : AppColors.whiteText.opacity(0.6))
//                
//                Text(guild.name)
//                    .font(.headline)
//                    .fontWeight(isCurrentGuild ? .bold : .medium)
//                    .foregroundColor(isCurrentGuild ? AppColors.accentColor : AppColors.whiteText)
//                
//                Spacer()
//                
//                if isCurrentGuild {
